...
int main() {
    ...
    // setup OpenGL usage
    SDL_Log("OpenGL minimal version: %d.%d", G_GL_MAJOR_VERSION, G_GL_MINOR_VERSION);
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, G_GL_MAJOR_VERSION);
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, G_GL_MINOR_VERSION);
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_PROFILE_MASK, G_GL_PROFILE);
